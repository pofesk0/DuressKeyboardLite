EN: This app is a simplified version of DuressKeyboard app. This app has higher target SDK (because it uses another mechanism for wipe data), but fewer features.
...
RU: Это приложение упрощенная версия приложения DuressKeyboard. Оно имеет более высокий target sdk (потому что использует другой механизм сброса данных), но меньше функций.
...
Download (скачать): https://github.com/pofesk0/DuressKeyboardLite/releases/latest
