...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		readInstructionsButton.setOnClickListener(new View.OnClickListener() {
				...
				private static final String in_ru="Привет. Это приложение DuressKeybordLite, созданное для защиты ваших личных данных. В нём вы можете задать код сброса (Duress Password). Этот код сотрёт все данные телефона при его вводе на экране блокировки и нажатии стрелки ввода (⏎). Для этого у вас на телефоне должен быть текстовый пароль, а код сброса должен отличаться от него, и клавиатура должна быть включена и выбрана по умолчанию на постоянной основе, тогда она будет работать как при обычном использовании, так и на экране блокировки на всех Android за исключением некоторых китайских прошивок (Realme, Oppo, ...)\n\nЭто клавиатура созданна для повседневнего использования и для постоянной готовности к ситуациям, когда вас могут заставить разблокировать телефон против вашей воли. Именно тогда вы вводите код сброса (DuressPassword) вместо обычного пароля и он активирует сброс телефона до заводских настроек.\n\nДумаете, это вам не пригодится? Вас могут заставить разблокировать телефон когда вы просто гуляете в парке, или идёте в магазин. Такое происходит всё чаще. Если вы отдадите посторонним свои личные данные даже под предлогом простой проверки, кем бы они не представлялись, ваши данные могут использовать для шантажа, а вы даже не сможете обратиться за помощью из-за опасения утечки со стороны вымогателей. Если вы просто сотрёте данные ещё до их предоставления, злоумышленники потеряют рычаги давления на вас.\n\nОсобенности клавиатуры:\n\nЯзыки и раскладки:\nАнглийский, Испанский, Русский, Символы, Смайлики;\n\nВы можете выбрать языки в главном меню;\n\n!#?, abc -> смена на символьную раскладку и обратно;\n\n😀 -> Переключение на смайлики;\n\n🌐 -> Смена языка;\n\nДолгое нажатие на ⌫ -> быстрое удаление текста;\n\nЕсли вы используете русскую раскладку:\nДолгое нажатие на ь -> ъ, е -> ё;​\n\nДополнительные функции:\n\nУстановка лимита попыток ввода пароля (настройки Авто-Сброса). Позволяет установить лимит попыток ввода пароля, что означает что если вы допустите количество ошибочных попыток равное этому лимиту, то данные будут стерты также как и при вводе кода сброса. За такую попытку считается ввод пароля длинной больше 4х символов, где вы допустили хоть 1 ошибку, тоесть если он не соответствует вашему паролю разблокировки экрана.\n\nПриложение также имеет режим Мёртвой Руки, который можно включить в главном меню. Он нужен чтобы предотвратить сценарий когда вас заставляют переключиться на другой способ ввода чтобы лишить вас возможности ввести код сброса. Он использует логику автоматического управления лимитом попыток, устанавливая его минимальное значение в 1, при этом когда клавиатура используется, увеличивает его перед каждой попыткой вплоть до 5. Это значит что когда вас заставляют обойти клавиатуру, вы можете просто ввести любой неверный пароль больше 4х символов для сброса данных, также как это делает код сброса, ведь у вас только 1 попытка. Пока вы используете клавиатуру, она защищает вас от случайных ошибок давая вам 5 попыток (прибавляя по 2 от текущих, перед отправкой ввода пока вы не достигните лимита в 5).\n\nИсходный код:\nhttps://github.com/pofesk0/DuressKeyboardLite/\nF-droid:\nhttps://f-droid.org/packages/duress.keyboard.lite/\n\nБольше функций в полной версии:\nhttps://f-droid.org/packages/duress.keyboard/\nЕё установка может быть сложнее. Подробнее:\nЗеркало 1:\nhttps://github.com/pofesk0/DuressKeyboard/\nЗеркало 2:\nhttps://github.com/pofesk0/lastcodeduresskeyboard/";
			    private static final String in_en="Hello. This is the DuressKeyboardLite application, created to protect your personal data. It lets you set a reset code (Duress Password). This code will erase all phone data upon its entry on the lock screen and pressing the enter arrow (⏎). For this you must have a text password on your phone, and the reset code must differ from it, and the keyboard must be enabled and selected by default on a permanent basis, then it will work both during normal use and on the lock screen on all Androids except some Chinese firmware (Realme, Oppo, ...)\n\nThis keyboard is created for everyday use and for constant readiness for situations when you may be forced to unlock the phone against your will. That's when you enter the reset code (DuressPassword) instead of the usual password and it will activate a factory reset of the phone.\n\nDo you think this won't come in handy? You may be forced to unlock the phone when you are just walking in the park, or going to the shop. This is happening more and more often. If you give your personal data to strangers even under the guise of a simple check, whoever they claim to be, they can use your data for blackmail, and you won't even be able to seek help due to fear of leakage on the part of extortionists. If you simply erase the data even before providing it, bad actors will lose leverage over you.\n\n​Keyboard features:\n\nLanguages and layouts:\nEnglish, Spanish, Russian, Symbols, Emojis;\n\nYou can select languages in the main menu;\n\n!#?, abc -> switch to symbol layout and back;\n\n😀 -> Switch to emojis;\n\n🌐 -> Language change;\n\nLong press on ⌫ -> quick text deletion;\n\nIf you use the Russian layout:\nLong press on ь -> ъ, е -> ё;\n\nAdditional features:\n\nSetting a limit on password entry attempts (Auto-Wipe settings). Allows you to set a limit on password entry attempts, which means that if you make a number of failed attempts equal to this limit, the data will be erased as well as when entering the reset code. Such an attempt is considered to be entering a password longer than 4 characters, where you made at least 1 error, i.e. if it does not correspond to your screen unlock password.\n\nThe application also has a Dead Hand mode, which can be enabled in the main menu. It is needed to prevent situations where you are forced to switch to another input method to take away your ability to enter the reset code. It uses automatic limit control logic, setting its minimum value to 1, while when the keyboard is used, increasing it before each attempt up to 5. This means that when you are forced to bypass the keyboard, you can simply enter any wrong password longer than 4 characters to reset the data, just as the reset code does, since you have only 1 attempt. While you are using the keyboard, it protects you from accidental errors giving you 5 attempts (adding 2 from current ones, before sending input until you reach the limit of 5).\n\nSource code:\nhttps://github.com/pofesk0/DuressKeyboardLite/\nF-droid:\nhttps://f-droid.org/packages/duress.keyboard.lite/\n\nMore features in the full version:\nhttps://f-droid.org/packages/duress.keyboard/\nIts installation may be more difficult. Details:\nMirror 1:\nhttps://github.com/pofesk0/DuressKeyboard/ \nMirror 2:\nhttps://github.com/pofesk0/lastcodeduresskeyboard/​";
